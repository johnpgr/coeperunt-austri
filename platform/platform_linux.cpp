...
static inline i64 __syscall4(i64 number, i64 a0, i64 a1, i64 a2, i64 a3) noexcept {
    i64 ret;
    #if defined(__x86_64__)
...
static inline i64 __syscall6(i64 number, i64 a0, i64 a1, i64 a2, i64 a3, i64 a4, i64 a5) noexcept {
    i64 ret;
    #if defined(__x86_64__)
        register i64 r10 __asm__("r10") = a3;
...
static FileContent __linux_read_entire_file(const char* filepath) noexcept {
    ...
    i64 fd = __syscall4(SYS_OPENAT, LINUX_AT_FDCWD, (i64)filepath, LINUX_O_RDONLY, 0);
    if (fd < 0) {
